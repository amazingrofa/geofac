...
p offset (δ_p) = p - sqrt(N) = -1,218,472,126,649,964,661
q offset (δ_q) = q - sqrt(N) = +1,359,753,648,750,032,543

|δ_p| = 1,218,472,126,649,964,661 ≈ 1.22×10¹⁵
|δ_q| = 1,359,753,648,750,032,543 ≈ 1.36×10¹⁵
```
